...
class StatusModule:
    ...
    Attributes:
        ...
        results_waived (Union[Unset, bool]):
    ...
    results_waived: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        results_waived = self.results_waived
        ...
        if results_waived is not UNSET:
            field_dict["resultsWaived"] = results_waived
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        results_waived = d.pop("resultsWaived", UNSET)
